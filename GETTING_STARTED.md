...
This guide will help you set up and test the Obsidian Metadata Tool plugin.
...
2. Add the key to the plugin:
   ...
   - Find "Metadata Tool" and click on it
...
- Go to Settings → Metadata Tool and add your key
